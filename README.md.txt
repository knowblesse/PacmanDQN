...
```shell
$ python3 pacman.py -l [layout name]
```
...
* getLegalNeighbors(position, walls)

###GameStateData

Get new state data from previous event. If no previous data, initialize all data.
...
Define colors and sizes of all the agents and food.
